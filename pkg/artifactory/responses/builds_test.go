...
func TestBuildsResponses(t *testing.T) {
	// Add any new test cases here
	// in the form of
	// {&FooResponse{}:FooResponseTestData}
	systemResponsesTestCases := []map[VersionedResponse]string{
		{&AllBuildsResponse{}: AllBuildsResponseTestData},
		{&BuildRunsResponse{}: BuildRunsResponseTestData},
		{&BuildInfoResponse{}: BuildInfoResponseTestData},
		{&BuildDiffResponse{}: BuildDiffResponseTestData},
	}
